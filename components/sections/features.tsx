...
import type { FeatureIconName } from "@/components/icons/feature-icon";
          ...
          {features.map((feature) => {
            ...
            return (
              <article
                key={feature.title}
                role="listitem"
                className={`rounded-lg border p-6 transition-all duration-300 ease-out 
                hover:-translate-y-1 hover:border-ocean/30
                focus-within:ring-2 focus-within:ring-ocean/30
                sm:p-7
                ${
                  isFeatured
              ...
              >
                ...
                <div
                  ...
                  className={`mb-5 inline-flex h-12 w-12 items-center justify-center rounded-lg sm:mb-6 ${
                    isFeatured ? "bg-white text-ink" : "bg-ink text-white"
                  }`}
                >
                ...
                <p
                  className={`mt-3 text-base leading-7 ${
                    isFeatured ? "text-white/70" : "text-ink/60"
                  }`}
                >
                  {feature.description}
                </p>
